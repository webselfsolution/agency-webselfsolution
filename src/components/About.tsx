    ...
    <div id="about" className="py-8 flex items-center flex-col">
      <div>
        ...
        <p className="mt-8 px-4 sm:px-0 md:w-[44rem] lg:w-[48rem] ml-[-1rem] sm:ml-0 md:tracking-wider mb-2 text-sm md:text-md lg:text-[1rem] text-gray-300 text-center">
          <span className="text-[1.2rem] md:text-xl lg:text-xl xl:text-2xl font-bold from-neutral-100 text-gray-300">Your trusted partner for business, <br /></span>webself was founded on the belief that every business deserves a
